...
def _save_config_file(model_checkpoints_folder):
    if not os.path.exists(model_checkpoints_folder):
        ...
        shutil.copy('fingprint/config_finetune.yaml', os.path.join(model_checkpoints_folder,
                                                                   'fingprint/config_finetune.yaml'))
...
if __name__ == "__main__":
    ...
    if config['task_name'] == 'BBBP':
        ...
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = 'data/downstream_data/tox21.csv'
        target_list = [
        ...
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = 'data/downstream_data/clintox.csv'
        target_list = ['CT_TOX', 'FDA_APPROVED']

    elif config['task_name'] == 'HIV':
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = 'data/downstream_data/HIV.csv'
        target_list = ["HIV_active"]

    elif config['task_name'] == 'BACE':
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = 'data/downstream_data/bace.csv'
        target_list = ["Class"]

    elif config['task_name'] == 'SIDER':
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = 'data/downstream_data/sider.csv'
        target_list = [
        ...
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = 'data/downstream_data/muv.csv'
        target_list = [
        ...
        config['dataset']['data_path'] = 'data/downstream_data/freesolv.csv'
        target_list = ["expt"]
    
    elif config["task_name"] == 'ESOL':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'data/downstream_data/esol.csv'
        target_list = ["measured log solubility in mols per litre"]

    elif config["task_name"] == 'Lipo':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'data/downstream_data/Lipophilicity.csv'
        target_list = ["exp"]
    
    elif config["task_name"] == 'qm7':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'data/downstream_data/qm7.csv'
        target_list = ["u0_atom"]

    elif config["task_name"] == 'qm8':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'data/downstream_data/qm8.csv'
        target_list = [
        ...
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'data/downstream_data/qm9.csv'
        target_list = ['mu', 'alpha', 'homo', 'lumo', 'gap', 'r2', 'zpve', 'cv']
    elif config["task_name"] == 'HPK1_IC50':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'data/inhibitors_data/HPK1_IC50.csv'
        target_list = ['label']
    else:
